...
Invoke-Pester -verbose -OutputFile 'test-result.xml' -OutputFormat NUnitXml -EnableExit -Script @{ Path = 'F:\GitHub\Source\SeleniumWin10\Freelancer.Tests.ps1'; Parameters = @{browser = 'firefoxgrid';};}
